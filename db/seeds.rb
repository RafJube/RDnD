...
cocoduck = Duck.new(user_id: bob.id, name: 'Coco', description: "A great duck, the best one to help you on cloudinary!", price: "50")
...
bohemian = Duck.new(user_id: bobette.id, name: 'Bohemian', description: "Just good !", price: "34")
...
duck_you = Duck.new(user_id: bobette.id, name: 'Duck You', description: "Meh !", price: "60")
...
black_sheep = Duck.new(user_id: bob.id, name: 'Black Sheep', description: "A alright !", price: "70")
