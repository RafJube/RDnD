...
cocoduck = Duck.new(user_id: 5, name: 'Coco', description: "A great duck, the best one to help you on cloudinary tool!", price: "50", skills: ["cloudinary"])
...
bohemian = Duck.create!(user_id: 5, name: 'Bohemian', description: "A great duck, the best one to help you !", price: "60", skills: ["cloudinary"])
...
duck_you = Duck.create!(user_id: 5, name: 'Duck You', description: "A great duck, the best one to help you !", price: "70", skills: ["cloudinary"])
...
black_sheep = Duck.create!(user_id: 5, name: 'Black Sheep', description: "A great duck, the best one to help you !", price: "70", skills: ["cloudinary"])
