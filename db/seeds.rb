...
cocoduck = Duck.new(user_id: 14, name: 'Coco', description: "A great duck, the best one to help you on cloudinary tool!", price: "50")
cocoduck.skills = Skill.all
...
# bohemian = Duck.new(user_id: 1, name: 'Bohemian', description: "A great duck, the best one to help you !", price: "34")
# bohemian.skill = Skill.all.sample.name
